import { createSession, getSession, updateSession, type LearningContext } from "./contextStore.js";
...
export function startWorkflow(sessionId: string, goal: string): StepResult {
